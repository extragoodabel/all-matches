...
export function AllMatchesLogo({ 
  ...
  const outlineColor = BRAND_COLORS.outlineYellow;
  const textOutlineFilter = withOutline 
    ? `drop-shadow(4px 0 0 ${outlineColor}) drop-shadow(-4px 0 0 ${outlineColor}) drop-shadow(0 4px 0 ${outlineColor}) drop-shadow(0 -4px 0 ${outlineColor}) drop-shadow(3px 3px 0 ${outlineColor}) drop-shadow(-3px 3px 0 ${outlineColor}) drop-shadow(3px -3px 0 ${outlineColor}) drop-shadow(-3px -3px 0 ${outlineColor})`
    : undefined;
  ...
  return (
    ...
    >
      <g>
        <path 
          fill={heartColor} 
          d="M208.14,35.57c-28.88-22.06-71.9-14.48-96.1,16.95-28.88-22.06-71.9-14.48-96.1,16.95-24.2,31.42-20.41,74.78,8.47,96.84l104.58,79.9,87.63-113.79c24.2-31.42,20.41-74.78-8.47-96.84Z"
          stroke={withOutline ? outlineColor : 'none'}
          strokeWidth={withOutline ? 8 : 0}
          strokeLinejoin="miter"
          paintOrder="stroke"
        />
        
        <g style={{ filter: textOutlineFilter }}>
          <g>
